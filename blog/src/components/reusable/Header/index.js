...
class Header extends PureComponent{  
    renderContent(handleThemes, drawerOpen, toggleSidebar){
      ...
      switch(this.props.auth){
        ...
        default:
          return <Navigation toggleSidebar={toggleSidebar} drawerOpen={drawerOpen} handleThemes={handleThemes} />
      }
    };

    render(){
      const { classes, toggleSidebar, drawerOpen, className, handleThemes, ...other } = this.props;
      return(
...
export default connect(mapStateToProps)(withStyles(styles, { name: 'Header', withTheme: true })(Header));